...
<?php  
 ...
 {  
      ...
      {  
       ...
       <button type="submit" name="block" value="Block" class="btn  btn-outline-danger" style="margin-left: -10px;" >Bloquear</button>
       <a type="button" style="color: white;" class="btn  btn-danger waves-effect" data-dismiss="modal">Cancelar</a>
       <input type="hidden" name="block_util" value="'.$row['idutilizador'].'">
       </form> ';  
