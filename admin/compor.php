...
if(isset($_GET['men'])){ $id = $_GET['men']; } else { $id = 0; }
...
if(isset($_POST['enviar']) && $_POST['enviar']=="Enviar"){
  ...
  $mensagem = Addslashes($_POST['editor1']);
  $assunto = Addslashes($_POST['assunto']);
  $email = $_POST['email'];
  $nome = $_POST['nome'];

  if(empty(trim($mensagem)) || empty(trim($assunto)) || empty(trim($nome)) || empty(trim($email))){
    echo "<meta http-equiv=refresh content='0; url=?pg=10&men=".$id."&erro=1'>";exit;
  } else {
...
$mail->AddEmbeddedImage('emails/email_back/images/bottom_rounded_15.png', 'bottom');
...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #6f7d5d;">
<!--[if IE]><div class="ie-browser"><![endif]-->
<table bgcolor="#6f7d5d" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #6f7d5d; width: 100%;" valign="top" width="100%">
<tbody>
<tr style="vertical-align: top;" valign="top">
<td style="word-break: break-word; vertical-align: top;" valign="top">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color:#6f7d5d"><![endif]-->
...
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">'.$rowc['email'].'</p>
</div>
</div>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="cid:logo" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 58px; display: block;" title="Image" width="58"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<div style="background-color:transparent;">
<div class="block-grid mixed-two-up no-stack" style="Margin: 0 auto; min-width: 320px; max-width: 500px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #4e5841;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:#4e5841;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:500px"><tr class="layout-full-width" style="background-color:#4e5841"><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="333" style="background-color:#4e5841;width:333px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;"><![endif]-->
...
<!--[if (mso)|(IE)]></td></tr></table><![endif]-->
<!--[if (mso)|(IE)]></td><td align="center" width="166" style="background-color:#a8b398;width:166px; border-top: 0px dotted #FFFFFF; border-left: 0px dotted #FFFFFF; border-bottom: 0px dotted #FFFFFF; border-right: 0px dotted #FFFFFF;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 5px; padding-left: 5px; padding-top:5px; padding-bottom:5px;"><![endif]-->
<div class="col num4" style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 164px; width: 166px;">
<div style="width:100% !important;">
<!--[if (!mso)&(!IE)]><!-->
<div style="border-top:0px dotted #FFFFFF; border-left:0px dotted #FFFFFF; border-bottom:0px dotted #FFFFFF; border-right:0px dotted #FFFFFF; padding-top:5px; padding-bottom:5px; padding-right: 5px; padding-left: 5px;">
<!--<![endif]-->
<table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">
<tbody>
<tr style="vertical-align: top;" valign="top">
...
<div style="color:#6f7d5d;font-family:Chivo, Arial, Helvetica, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="line-height: 1.5; font-size: 12px; color: #6f7d5d; font-family: Chivo, Arial, Helvetica, sans-serif; mso-line-height-alt: 18px;">
<p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;">'.$mensagem.'</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center autowidth fullwidth" src="cid:bottom" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 500px; display: block;" title="Image" width="500"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://www.facebook.com/'.$rowc['fb'].'" target="_blank"><img alt="Facebook" height="32" src="cid:fb" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Facebook" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://twitter.com/'.$rowc['twitter'].'" target="_blank"><img alt="Twitter" height="32" src="cid:twitter" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Twitter" width="32"/></a></td>
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px;" valign="top"><a href="https://instagram.com/'.$rowc['insta'].'" target="_blank" ><img alt="Instagram" height="32" src="cid:insta" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block;" title="Instagram" width="32"/></a></td>
</tr>
</tbody>
</table>
</td>
...
$mail->SMTPDebug = 0;
  ...
  if($mail->send()){
    $sql_up=$conn->query("update mensagens set respondido=1 where idmensagem='".$id."'") or die("Falha ao editar o pefil");
    $sql_insereregisto=$conn->query("Insert into resposta_mensagm (idmensagem, assunto, mensagem, data_escrita) VALUES ('".$id."', '".$assunto."', '".$mensagem."', CURRENT_TIMESTAMP) ") or die("Erro ao inserir o registo");
    echo "<meta http-equiv=refresh content='0; url=?pg=9&m=22'>";exit;
  } else {
    echo "<meta http-equiv=refresh content='0; url=?pg=10&men=".$id."&erro=1'>";exit;
  }
}
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="card card-primary card-outline">
              <?php 
              if(isset($_GET['men'])){ $id = $_GET['men']; } else { $id = 0; }
              $sql_comp=$conn->query("select mensagens.*,utilizadores.nome as utilizadores from mensagens, utilizadores where utilizadores.idutilizador=mensagens.idutilizador AND mensagens.idmensagem='".$id."'") or die("Erro ao selecionar o nome.");
              if($sql_comp->num_rows>=1){
              $row=$sql_comp->fetch_assoc(); 
                      ?>
              <div class="card-header">
                <h3 class="card-title">Responda a <?php echo $row['utilizadores'].$id ;?> </h3>
              </div>
              <!-- /.card-header -->
              <form action="?pg=10&men=<?php echo $id;?>" method="post">
                <input name="nome" type="hidden" value="<?php echo $row['utilizadores'];?>">
                <div class="card-body">
                  <div class="form-group">
                    <label>Para:</label>
                    <input class="form-control" name ="email" value="<?php echo $row['email'];?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>Assunto:</label>
                    <input class="form-control" name="assunto" value="<?php echo $row['assunto'];?>" >
                  </div>
                  <div class="form-group">
                      <label>Mensagem:</label>
                      <textarea id="compose-textarea" class="form-control" id="editor" name="editor1" >
                      </textarea>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <div class="float-right">
                    <button type="submit" name="enviar" value="Enviar" class="btn btn-primary"><i class="far fa-envelope"></i> Enviar</button>
                  </div>
                </div>
              </form>
              <!-- /.card-footer -->
            ...
            <?php } else { 
              $sql_comp2=$conn->query("select * from mensagens where idmensagem='".$id."'") or die("Erro ao selecionar o nome.");
              $row2=$sql_comp2->fetch_assoc();
              ?>
              <div class="card-header">
                <h3 class="card-title">Respondendo a mensagem</h3>
              </div>

              <form action="?pg=10&men=<?php echo $id;?>" method="post">
                <input name="nome" type="hidden" value="<?php echo $row2['email'];?>" required>
                <div class="card-body">
                  <div class="form-group">
                    <label>Para:</label>
                    <input class="form-control" name ="email" value="<?php echo $row2['email'];?>" readonly required>
                  </div>
                  <div class="form-group">
                    <label>Assunto:</label>
                    <input class="form-control" name="assunto" value="<?php echo $row2['assunto'];?> - resposta" required>
                  </div>
                  <div class="form-group">
                      <label>Mensagem:</label>
                      <textarea id="compose-textarea" class="form-control" id="editor" name="editor1" >
